...
import { createDoctorAccount } from '@/lib/api/APIHandler';
import { useState } from 'react';
import styles from './index.module.css';

const CreateHospitalUserModal = (props: { hospitalId: string; isOpen: boolean; onClose: () => void; callbackAfterTriggerAPI: () => void }) => {
    // 入力値
    ...
    const callCreateHospitalUserAPI = () => {
        if (!validateInput()) {
            createDoctorAccount(email, password, username, props.hospitalId).then(() => {
                resetAllInput();
        ...
        >
            <>
                ...
                <div className={styles.btnWrapper}>
                    <Button onClick={callCreateHospitalUserAPI}>登録する</Button>
                </div>
            </>
        </Modal>
    );
...
export default CreateHospitalUserModal;
