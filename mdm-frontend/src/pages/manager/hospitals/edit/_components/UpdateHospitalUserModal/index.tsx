...
const UpdateHospitalUserModal = (props: {
    userId: string;
    username: string;
    email: string;
    isOpen: boolean;
    ...
    const callUpdateHospitalUserAPI = () => {
        if (!validateInput()) {
        ...
        >
            <>
                ...
                <div className={styles.btnWrapper}>
                    <Button onClick={callUpdateHospitalUserAPI}>更新する</Button>
                </div>
            </>
        </Modal>
    );
...
export default UpdateHospitalUserModal;
